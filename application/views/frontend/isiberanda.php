<div class="slider">
		<ul class="bxslider">
			<li>
			<img src="<?= base_url('assets/');?>images/pic_slide.jpg" alt="Radio On Demand" style="height:300px width:100%;">
				<div class="container">
					<div class="info">
			...
			<li>
			<img src="<?= base_url('assets/');?>images/pic_slide1.jpg" alt="Radio On Demand" style="height:300px width:100%;">
				<div class="container">
					<div class="info">
						<h2>It’s Time to <br><span>Get back to school</span></h2>
						<a href="#">Check out our new programs</a>
	...
	<section class="posts">
		<div class="container">
			<article>
				<div class="pic"><img width="121" src="<?= base_url('assets/');?>images/2.png" alt=""></div>
				<div class="info">
			...
			<article>
				<div class="pic"><img width="121" src="<?= base_url('assets/');?>images/3.png" alt=""></div>
				<div class="info">

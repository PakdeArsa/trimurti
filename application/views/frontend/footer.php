<footer id="footer">
		<div class="container">
			...
			<p class="copy">Copyright 2018 SMA Trimurti Surabaya. Designed by <a href="http://www.mediajelajahnusantara.net/" title="Media Jelajah Nusantara" target="_blank">MJN</a>. All rights reserved.</p>
		</div>
		<!-- / container -->
	</footer>
	<!-- / footer -->